...
import type { ExternalBlob as _ExternalBlob, PaymentConfirmation as _PaymentConfirmation, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getPaymentConfirmation(arg0: string): Promise<PaymentConfirmation> {
        if (this.processError) {
            try {
                const result = await this.actor.getPaymentConfirmation(arg0);
                return from_candid_PaymentConfirmation_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitPayment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPayment(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PaymentConfirmation_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PaymentConfirmation): Promise<PaymentConfirmation> {
...
async function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        phone: value.phone,
        screenshot: await from_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.screenshot)
    };
}
